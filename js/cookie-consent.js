...
const CookieConsent = {
    ...
    init() {
        ...
        this.loadConsent();
        console.log('[CookieConsent] Consent loaded:', this.config.categories.analytics.enabled);
        this.createBanner();
        this.attachEventListeners();

        // Load analytics if consent was previously given
        if (this.hasConsent('analytics')) {
            console.log('[CookieConsent] Analytics consent found, loading analytics...');
            this.loadAnalytics();
        } else {
            console.log('[CookieConsent] No analytics consent found');
        }
    },
    ...
    createBanner() {
        ...
        console.log('[CookieConsent] Checking if consent exists:', !!consent);
        if (consent) {
            console.log('[CookieConsent] Consent already exists, not showing banner');
            return; // Don't show if already answered
        }
            ...
            <div class="cookie-consent-content">
                <div class="cookie-consent-text">
                    ...
                    <p class="cookie-consent-description">
                        ...
                        For more information, see our <a href="/pp.html">Privacy Policy</a> and
        ...
        console.log('[CookieConsent] Banner added to DOM');
    ...
    loadAnalytics() {
        ...
        // Google Analytics 4
        // Using provided GA4 Measurement ID for Synoriya
        const gaScript = document.createElement('script');
        gaScript.async = true;
        gaScript.src = 'https://www.googletagmanager.com/gtag/js?id=G-JP77YB38X1';
        document.head.appendChild(gaScript);

        window.dataLayer = window.dataLayer || [];
        function gtag() { dataLayer.push(arguments); }
        gtag('js', new Date());
        gtag('config', 'G-JP77YB38X1', {
